...
PROJECT_IMAGES["ipa-brand-lionna"] = {
  ...
  gallery: [
    // Exterior arrival frame — the glass terrace at golden hour,
    // table dressed before the night moves into the red salon.
    // Reads as the daylight prelude that lets the interior story
    // land harder.
    {
      src: `${IPA_DIR}/event-07-ipa-exterior.png`,
      alt: "IPA Brand at Li-Onna — glass terrace, golden hour, dressed table before the night",
      aspect: "aspect-[4/5]",
    },
  ...
  en: {
    ...
    "ipa-brand-lionna": {
      ...
      sections: [
        {
          label: "Arrival",
          body: "Before the red, a quieter beginning — a long table set on Li-Onna’s glass terrace, dressed in linen and candlelight. Boxwood, black steel and the last gold of the day frame the night's first table, with the salon still waiting inside.",
        },
        {
          label: "Atmosphere",
  ...
  es: {
    ...
    "ipa-brand-lionna": {
      ...
      sections: [
        {
          label: "Llegada",
          body: "Antes del rojo, un comienzo más calmado — una mesa larga dispuesta sobre la terraza acristalada de Li-Onna, vestida con lino y velas. Boj, acero negro y la última luz dorada del día enmarcan la primera mesa de la noche, con el salón aún esperando dentro.",
        },
        {
          label: "Atmósfera",
